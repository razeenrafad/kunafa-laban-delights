  ...
  head: () => ({
    meta: [
      ...
      { title: "Kunafa Story | Premium Kunafa & Laban Story Desserts" },
      {
        name: "description",
        content:
          "Kunafa Story is a premium dessert house serving small-batch molten kunafa, with Laban Story pouring chilled cultured drinks.",
      },
      { name: "author", content: "Kunafa Story" },
      { property: "og:title", content: "Kunafa Story | Premium Dessert House" },
      {
        property: "og:description",
        content: "Small-batch molten kunafa and chilled Laban Story pours.",
      },
